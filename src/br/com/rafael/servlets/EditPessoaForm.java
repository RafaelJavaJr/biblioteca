...
public class EditPessoaForm extends HttpServlet {
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.print("<input type='text' class='form-control' value='"+bean.getNome()+"' name='name' id='name1' placeholder='Name'/>");
		out.print("</div>");
		out.print("<div class='form-group'>");
		...
		out.print("<input type='password' class='form-control' value='"+bean.getSenha()+"'  name='password' id='password1' placeholder='Password'/>");
		out.print("</div>  ");
		out.print("<div class='form-group'>");
		out.print("<label for='mobile1'>Mobile Number</label>");
		out.print("<input type='number' class='form-control' value='"+bean.getTelefone()+"'  name='mobile' id='mobile1' placeholder='Mobile'/>");
		out.print("</div>");
